...
export type Database = {
  _analytics: {
    Tables: {
      ...
      log_events_05f725d4_cd4b_47ed_ab03_088cbb52ab78: {
        Row: {
          body: Json | null
      ...
      log_events_0bc86357_1d20_46f3_9fff_b6a47f5f93a3: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_0da4970d_ed0d_4afe_94a4_75afcde74ce6: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_1009f18a_d428_463a_bd3a_2e4d80af9507: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_30ee44e5_e572_494a_9914_c8bee85f7deb: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_503c69f1_ff07_475a_b620_736d2ca8962f: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_7d718460_3566_4cde_989f_2c101c37f4b8: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_d9adec85_6212_4a35_b16d_80fe6f3f9da0: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
      ...
      log_events_e62d26e5_1395_4c9e_8341_6c64330b8211: {
        Row: {
          body: Json | null
          event_message: string | null
          id: string
  ...
  public: {
    Tables: {
      ...
      activity_logs: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            referencedRelation: "participant_activity_counts"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "activity_logs_participant_id_fkey"
      ...
      activity_sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "activity_sessions_event_id_fkey"
            columns: ["event_id"]
            referencedRelation: "events"
            referencedColumns: ["id"]
          },
      ...
      checkin_history: {
        Row: {
          event_id: string | null
          id: string
          original_check_in_method: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "checkin_history_event_id_fkey"
            columns: ["event_id"]
            referencedRelation: "events"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "checkin_history_unchecked_by_fkey"
            columns: ["unchecked_by"]
            referencedRelation: "staff_profiles"
            referencedColumns: ["id"]
          },
        ]
      ...
      comm_channel_members: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "comm_channel_members_staff_id_fkey"
            columns: ["staff_id"]
            referencedRelation: "staff_profiles"
            referencedColumns: ["id"]
          },
      ...
      comm_channels: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "comm_channels_event_id_fkey"
            columns: ["event_id"]
            referencedRelation: "events"
            referencedColumns: ["id"]
          },
      ...
      comm_mentions: {
        Row: {
          ...
          created_at: string | null
          id: string
          mentioned_staff_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "comm_mentions_channel_id_fkey"
            columns: ["channel_id"]
            referencedRelation: "comm_channels"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "comm_mentions_mentioned_staff_id_fkey"
            columns: ["mentioned_staff_id"]
            referencedRelation: "staff_profiles"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "comm_mentions_message_id_fkey"
            columns: ["message_id"]
      ...
      service_providers: {
        ...
        Relationships: [
          {
            foreignKeyName: "service_providers_event_id_fkey"
            columns: ["event_id"]
            referencedRelation: "events"
            referencedColumns: ["id"]
          },
      ...
      session_participations: {
        ...
        Relationships: [
          {
            foreignKeyName: "session_participations_activity_id_fkey"
            columns: ["activity_id"]
            referencedRelation: "activities"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "session_participations_event_id_fkey"
            columns: ["event_id"]
            referencedRelation: "events"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "session_participations_generated_by_fkey"
            columns: ["generated_by"]
            referencedRelation: "staff_profiles"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "session_participations_participant_id_fkey"
            columns: ["participant_id"]
            referencedRelation: "participant_activity_counts"
            referencedColumns: ["id"]
          },
          ...
          {
            foreignKeyName: "session_participations_verified_by_fkey"
            columns: ["verified_by"]
            referencedRelation: "staff_profiles"
            referencedColumns: ["id"]
          },
      ...
      staff_audit_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "staff_audit_logs_event_id_fkey"
            columns: ["event_id"]
            referencedRelation: "events"
            referencedColumns: ["id"]
          },
      ...
      staff_profiles: {
        ...
        Relationships: [
          {
            foreignKeyName: "staff_profiles_assigned_event_id_fkey"
    ...
    Functions: {
      ...
      get_or_create_dm: {
        Args: { p_other_staff_id: string }
        Returns: string
      }
      is_comm_channel_member: {
        Args: { p_channel_id: string }
        Returns: boolean
      }
      reset_event_attendance: {
        Args: {
          p_event_id: string
          p_reason?: string
          p_reset_activity_logs?: boolean
          p_reset_crew?: boolean
          p_reset_participants?: boolean
          p_reset_sps?: boolean
          p_staff_id?: string
          p_staff_name?: string
        }
